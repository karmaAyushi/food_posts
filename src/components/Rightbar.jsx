    ...
    return (
      <Box flex={2} p={2} sx={{ display: { xs: "none", sm: "block" } }}>
        ...
        <ListItem alignItems="flex-start">
          <ListItemAvatar>
            <Avatar alt="Remy Sharp" src="https://1.bp.blogspot.com/-OUoEcwf5MtQ/X3f4k-Jyy8I/AAAAAAAAAsc/mBLx1oSaChA9jUcbl6mMSfBIPRYYE4-ugCLcBGAsYHQ/s16000-rw/beautiful%2Bgirls%2Bimages%2Bhd%2B%25282%2529.jpg" />
          </ListItemAvatar>
          <ListItemText
